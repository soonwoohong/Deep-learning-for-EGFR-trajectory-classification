...
from keras.layers import Dropout, Dense, Flatten, Conv1D, MaxPooling1D, BatchNormalization
...
def get_model():
    ...
    stride=2
    model = Sequential()
    x = (Conv1D(input_shape=(max_length,2), filters=96, kernel_size=block_kernel, padding="same", activation="relu"))(inputs)
